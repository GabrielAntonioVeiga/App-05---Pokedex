...
interface PokemonService {
    ...
    suspend fun listarPorHabilidade(@Query("habilidade") habilidade: String): List<PokemonRequest>

    @GET("pokemon/by-tipo")
    suspend fun listarPorTipo(@Query("tipo") tipo: String): List<PokemonRequest>
